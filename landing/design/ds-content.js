...
` },
  ...
  { id: 'shipped', label: 'As Shipped', html: `
    ...
    <!-- Filled at runtime by ds.js from the loaded stylesheets. Generating this
         list statically is what the page was doing wrong in the first place: a
         hand-written inventory of another file's contents goes stale the moment
         that file changes, which is the drift this section exists to expose. -->
    <div id="ds-drift"></div>
